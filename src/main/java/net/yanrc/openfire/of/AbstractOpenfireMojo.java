...
import java.text.SimpleDateFormat;
 ...
 public abstract class AbstractOpenfireMojo extends AbstractMojo
 {
      ...
      *
      * @parameter expression="${basedir}/src/main/webapp/database"
      * @required
      */
      ...
      *
      * @parameter expression="${basedir}/src/main/webapp/i18n"
      * @required
      */
     ...
     * @throws InterpolationException 
     ...
     public void buildWebapp(MavenProject project, File openfirePluginDirectory)
             throws MojoExecutionException, IOException, MojoFailureException, InterpolationException
     {
     ...
     * @throws InterpolationException 
      */
     private String getFinalName(Artifact artifact) throws InterpolationException
     {
